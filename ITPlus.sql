...
INSERT INTO `request` (`id`, `startDate`, `type_id`, `orgTechModel`, `problemDescryption`, `status_id`, `completionDate`, `repairParts`, `master_id`, `customer_id`) VALUES
...
(12, 'ннн', '+7(915)-443-34-18', 'nerius', 'bebf8b7c5f3240c20f051bab3c75f5fd', 1);
...
ALTER TABLE `request`
  ...
  ADD CONSTRAINT `request_ibfk_4` FOREIGN KEY (`type_id`) REFERENCES `type` (`id`),
  ADD CONSTRAINT `request_ibfk_5` FOREIGN KEY (`master_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `request_ibfk_6` FOREIGN KEY (`customer_id`) REFERENCES `user` (`id`);
